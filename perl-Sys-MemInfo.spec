...
Requires: perl-Sys-MemInfo-lib
Requires: perl-Sys-MemInfo-license
Requires: perl-Sys-MemInfo-man
...
%package man
Summary: man components for the perl-Sys-MemInfo package.
Group: Default

%description man
man components for the perl-Sys-MemInfo package.
...
mkdir -p %{_topdir}/BUILD/Sys-MemInfo-0.99/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Sys-MemInfo
cp LICENSE %{buildroot}/usr/share/doc/perl-Sys-MemInfo/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/Sys/MemInfo.pm

%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/Sys/MemInfo/MemInfo.so

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Sys-MemInfo/LICENSE
